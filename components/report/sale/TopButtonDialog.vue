<template>
  <div class="w-full flex flex-col">
    ...
    <div
      class="p-[18px] bg-lotion border rounded-lg flex justify-evenly items-center mt-4"
    >
      <div>
        <input
          type="number"
          placeholder="10"
          class="px-5 py-3 border rounded-lg w-[110px]"
        />
      </div>

      <div class="grid grid-cols-2 tab-btn w-[181px]">
        <button
          class="px-3 py-3 fs-14 fw-4 rounded-l-lg"
      ...
      <div class="flex w-[163px]">
        <DatePicker />
      </div>
    </div>
    <div class="border rounded-lg w-full h-[244px] mr-3 relative mt-4">
