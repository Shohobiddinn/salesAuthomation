<template>
  <div class="w-full">
    ...
    <div class="grid grid-cols-2 gap-6 mt-4">
      <button class="fs-14 bg-[#FAFDFD] border rounded-lg py-3" @click="$emit('closeDialog')">
        Нет, выйти
      </button>
      <button class="fs-14 bg-[#D10505] rounded-lg text-white disabled" @click="$emit('onDelete')">
        Да, удалить
      </button>
    </div>
  </div>
