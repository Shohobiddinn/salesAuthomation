...
const getClients = async () => {
  clients.value = await dashboardExpeditorsActRecStore.getClients(clientsParams.value);
};
...
const getPriceTypes = async () => {
  priceTypes.value = await dashboardExpeditorsActRecStore.getPriceTypes(
...
const save = async (e) => {
  ...
  // await dashboardExpeditorsActRecStore.add(form);
  console.log(form);
