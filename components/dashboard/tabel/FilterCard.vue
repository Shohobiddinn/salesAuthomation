  ...
  <rounded-white-container class="gap-4">
    ...
    <flex-row class="gap-4 mt-4"
      ...
      <flex-col class="w-full"
        ...
        <flex-row v-if="cols.key === 'btn'" class="h-full items-end gap-2">
        ...
        <DatePicker v-if="cols.key === 'date'" class="mt-5"/>
        <menu-btn class="w-full"
                  v-if="cols.key !== 'btn' && cols.key !== 'range' && cols.key !== 'radio' && cols.key !== 'data' && cols.key !== 'date'">
          <template #btn>
            <m-btn-outlined
