  ...
  <rounded-white-container class="gap-4">
    ...
    <flex-row class="gap-4 mt-4"
      ...
      <flex-col class="w-full"
        ...
        <div v-if="cols.key === 'data'" class="grid grid-cols-2 gap-4 -mt-1">
          <div>
            <div class="fs-12 ">Дата отгрузки</div>
            <div class="flex-row mt-1">
              <select class="border border-blue-20 w-full h-9.5 bg-[#FAFDFD] rounded-lg mt-[1px] mr-[18px] pl-[15px]">
