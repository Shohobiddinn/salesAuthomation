   ...
   <div class="w-full">
     ...
     <div class="flex justify-center w-full mt-7">
       <div class="fs-14 text-center w-[250px] font-[400]">
         Внимание!!! Удаленные агенты могут быть восстановленны только через 24 часа.
       </div>
     </div>
     <div class="flex justify-center w-full mt-5">
       <div class="fs-16 flex text-center justify-center w-[250px] font-[400]">
         <label>
           <input type='checkbox' v-model="agentStore.acceptDeleting">
           <span></span>
         </label>
         <div class="ml-3">
           Я согласен
     ...
     <div class="grid grid-cols-2 gap-6 mt-4">
       <button class="fs-14 bg-[#FAFDFD] border rounded-lg py-3"
               @click="agentStore.closeDeleteDialog">
         Нет, выйти
       </button>
       <button class="fs-14 bg-[#D10505] rounded-lg text-white disabled"
               @click="agentStore.deleteAgent">
         Да, удалить
       </button>
     </div>
   </div>
