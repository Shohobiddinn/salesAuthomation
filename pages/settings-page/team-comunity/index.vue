<template>
  <div class="mt-[41px]">
    ...
    <div class="text-[18px] font-[600] mt-4 mb-4">Team Comunity</div>
          ...
          <template #body>
            <c-tr v-for="data in loadedData" :key="data">
              <c-td-no-edit
                ...
                :key="key"
                :style="{ borderRight: key.borderR }"
              >
                <div class="pt-2 pb-2" v-if="key.checked === false">
                  {{ data[key.key] }}
                </div>
              </c-td-no-edit>
            </c-tr>
...
const link = ref("/settings-page/partner-tranzaction");
