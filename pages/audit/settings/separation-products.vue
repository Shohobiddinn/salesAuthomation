  ...
  <div>
    <div class="my-[29px]">
      <RoundedWhiteContainer>
        ...
        >
          <div>
            <span class="text-lg font-semibold"> Разделения продуктов </span>
          </div>
        ...
        <DoubleTab first-tab-name="Активный" second-tab-name="Не активный">
          <template #first>
            <AuditSettingsSeparationProductsDataTable
              :is-active="true"
    ...
    <transition name="modal">
      <div v-if="popUpIsOpen">
        <d-modal
          ...
          :name="'Изменить'"
          :dataContainerWidth="'405px'"
        >
          <AuditSettingsSeparationProductsDataDialog />
        </d-modal>
      </div>
    </transition>
  </div>
